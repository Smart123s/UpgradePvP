...
public class SetSpawnCommand extends UPvPCommand{
	...
	public void run(String[] args, Player player) {
		...
		if (args.length == 2) {
			...
			UPvPMap.get(args[1]).setSpawn(player.getLocation());
			player.sendMessage(Main.prefix + "Successfully set the spawn of map " + args[1]);
		} else {
			player.sendMessage(Main.prefixError + "/UPvP setspawn <map>");
		}
	}
